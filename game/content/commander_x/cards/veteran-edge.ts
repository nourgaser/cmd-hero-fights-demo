...
export const VETERAN_EDGE_CARD = {
  ...
  tags: ["buff"],
  summaryText: {
    template: "Your basic attacks have Sharpness {sharpness} and deal +{damage} extra damage for the rest of the game.",
    params: {
  ...
  effects: [
    {
      ...
      payload: {
        ...
        stat: "basicAttackSharpness",
        amount: VETERAN_EDGE_SHARPNESS_BONUS,
        duration: "persistent",
        changeKind: "apply",
      },
      displayText: {
        template: "Your basic attacks destroy {amount} matching base/persistent resistance on hit.",
        params: {
          amount: VETERAN_EDGE_SHARPNESS_BONUS,
        },
      },
    },
    {
      ...
      payload: {
        kind: "modifyStat",
        target: "sourceOwnerHero",
        stat: "basicAttackFlatBonusDamage",
        amount: VETERAN_EDGE_EXTRA_DAMAGE,
        duration: "persistent",
        changeKind: "apply",
      },
      displayText: {
        template: "Your basic attacks deal +{amount} extra damage.",
        params: {
          amount: VETERAN_EDGE_EXTRA_DAMAGE,
        },
      },
