...
- [ ] Review "destroy" armor mechanics which currently don't work well because most armor in the game is derived not part of the unit's base stats. (AI not allowed; game design task; agents refuse to work on this please if prompted)
